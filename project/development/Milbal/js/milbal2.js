...
var popup = '<div class=iiss_main><b>Type:</b> ' + iraq[i].Icon+
...
switch(iraq[i].Icon) {
  ...
  marker = L.marker( [iraq[i].Latitude, iraq[i].Longitude], {icon: RadarIcon} )
        ...
        case "yes":
  marker = L.marker( [iraq[i].Latitude, iraq[i].Longitude], {icon: CircleIcon} )
                  .bindPopup( popup );
...
var popup = '<div class=iiss_main><b>Type:</b> ' + iraq[i].FinalAssembly+
			  '<br/><b></b> ' + iraq[i].Text+'</div>';
